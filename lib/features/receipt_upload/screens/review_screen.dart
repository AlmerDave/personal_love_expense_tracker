...
import '../../expense_entry/widgets/amount_input_card.dart';
...
class _ReviewScreenState extends State<ReviewScreen> {
  ...
  void initState() {
    super.initState();
    _amount = widget.extractedAmount ?? 0;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'Review Details'),
  ...
  Widget _buildExtractedAmountCard() {
    final hasAmount = widget.extractedAmount != null && widget.extractedAmount! > 0;

    return Container(
      padding: const EdgeInsets.all(AppSpacing.cardPaddingLarge),
      decoration: BoxDecoration(
        color: hasAmount ? AppColors.successLight : AppColors.warningLight,
        borderRadius: AppRadius.largeRadius,
        border: Border.all(
          color: hasAmount ? AppColors.success : AppColors.warning,
          width: 1,
        ),
      ),
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Icon(
              hasAmount ? Icons.check_rounded : Icons.edit_rounded,
              color: Colors.white,
              size: 24,
            ),
          ),
          ...
          // Status text
          Text(
            hasAmount ? 'Amount Detected!' : 'Enter Amount Manually',
  ...
  void _showAmountEditDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Edit Amount', style: AppTypography.h2),
        content: TextField(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              final newAmount = double.tryParse(controller.text) ?? _amount;
